...
const solutions = [
  ...
  {
    title:
      "A Four axis Immersion Testing System for Evaluation of dis similar metal Fusion Joints",
    client: "",
    description:
  ...
  return (
    <div className="container py-5">
        ...
        {solutions.map((solution, index) => (
          <div key={index} className="row align-items-center mb-5">
            {index % 2 === 0 ? (
              <>
                {/* Left Side - Image */}
                <div className="col-md-6 order-1 order-md-0 image-container">
                  <div
                  ...
                  >
                    <Image
                      ...
                      layout="responsive"
                      priority
                      className="img-fluid rounded-4 shadow-lg transition-image"
                    />
                  </div>
                </div>
                {/* Right Side - Content */}
              ...
              <>
                ...
                {/* Right Side - Image */}
                <div className="col-md-6 order-0 order-md-1 image-container">
                  <div
                    className="image-wrapper"
                    onMouseEnter={() => setHoverIndex(index)}
                    onMouseLeave={() => setHoverIndex(null)}
      ...
      <style jsx>{`
        ...
        .image-wrapper:hover .transition-image {
